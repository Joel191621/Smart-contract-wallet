 ...
 * @dev UUPS Upgradeable Smart Contract Wallet implementation controlled by an EOA Owner.
 */
contract SmartWalletImplementation is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    /**
     * @dev Initializes the proxy wallet ownership.
     * @param initialOwner Address of the EOA owner/signer.
     */
    function initialize(address initialOwner) public initializer {
        require(initialOwner != address(0), "SmartWallet: owner cannot be zero address");
        __Ownable_init(initialOwner);
    }

    /**
     * @dev Function that authorizes an upgrade to a new implementation.
     * Guarded strictly by onlyOwner.
     */
    function _authorizeUpgrade(address newImplementation) internal override onlyOwner {}

    /**
     * @dev Returns current wallet implementation version.
     */
